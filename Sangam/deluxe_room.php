        ...
        <div class="row">
          <div class="col-sm-12 mt50">
            <h2 class="lined-heading"><span>Room Details</span></h2>
                        <p class="mt50">Spacious, bright and outward facing rooms measuring 145sqft and totally refurbished. The room comes with double bed with kur-lon mattress (manufactured and designed exclusively  for Hotel Sai Sangam), a modern, fully equipped bathroom finished in top quality bronze & White coloured ceramics and an independent entrance.</p>
