...
<div id="container">
    ...
    <main>
    	<div class="centre">
            ...
            <!-- Contact Form | END -->
            <h2 style="margin:0;"><strong>02423-256005 / 07768866005</strong></h2>
            <p style="margin:0;"><a href="mailto:reservations@hotelnetrasaishirdi.com">reservations@hotelnetrasaishirdi.com</a><br />
            Near Sai Temple,Palkhi Road<br/>
Near Sai Nagri Bank,Shirdi(M.S.)-423109<br />
        </div>
        <!-- Google Map | START -->
        <script>
			function initialize() {
			var latlng = new google.maps.LatLng(-19.764890,74.478577);
			var myOptions = {
			zoom: 14,
			center: latlng,
